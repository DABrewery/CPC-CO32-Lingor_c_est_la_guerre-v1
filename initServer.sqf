...
/* IA number param */
	//Get number of players or mission param to allow dynamic ENI units number adaptation
	private _paramAI = "NbAI" call BIS_fnc_getParamValue;
	if (_paramAI == 0) then {
